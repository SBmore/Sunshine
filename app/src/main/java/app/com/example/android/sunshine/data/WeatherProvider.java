...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        String weatherWithLocPath = weatherPath + "/*";
        String weatherWithLocAndDate = weatherPath + "/*/#";

        // 2) Use the addURI function to match each of the types.  Use the constants from
        // WeatherContract to help define the types to the UriMatcher.
        matcher.addURI(authority, weatherPath, WEATHER);
        matcher.addURI(authority, weatherWithLocPath, WEATHER_WITH_LOCATION);
        matcher.addURI(authority, weatherWithLocAndDate, WEATHER_WITH_LOCATION_AND_DATE);
        matcher.addURI(authority, locationPath, LOCATION);
